...
- PROJECT DOCS (SRS, SDS) ARE AUTO-INJECTED AT SESSION START VIA `flowai-session-init-docs` HOOK. IF HOOK IS NOT INSTALLED, READ THESE FILES FIRST: documents/requirements.md, documents/design.md.
