...
export const SetupCodeStyleTsStrictBasicBench = new class
  ...
  id = "flowai-skill-setup-agent-code-style-ts-strict-basic";
  ...
  userQuery =
    "/flowai-skill-setup-agent-code-style-ts-strict Add TypeScript strict mode code style rules to this project.";
