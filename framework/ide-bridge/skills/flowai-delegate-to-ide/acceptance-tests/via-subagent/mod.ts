...
/**
 * Skill must invoke the `flowai-ide-bridge-worker` subagent for delegation,
...
export const DelegateToIdeViaSubagentBench = new class
  ...
  id = "flowai-delegate-to-ide-via-subagent";
