...
<evidence>
  <user_query>
  /conduct-qa-session We are setting up observability and want to pick which signals to ship to the central platform. Ask me to choose any subset from: metrics, traces, profiles, logs, real-user-monitoring. Treat this as multi-select.
  </user_query>
...
Date:   Thu Apr 30 02:49:13 2026 +0300
 ...
 .claude/agents/agent-adapter.md             |   57 +
 .claude/agents/console-expert.md            |   59 ++
 .claude/agents/deep-research-worker.md      |  140 +++
 .claude/agents/diff-specialist.md           |   98 ++
 .claude/agents/skill-adapter.md             |   56 +
 .claude/assets/AGENTS.template.md                  |  284 +++++
 .claude/skills/adapt/SKILL.md               |  119 +++
 .claude/skills/commit-beta/SKILL.md         |  138 +++
 .claude/skills/commit/SKILL.md              |  133 +++
 .claude/skills/init/SKILL.md                |  203 ++++
 .../init/scripts/generate_agents.test.ts    |  319 ++++++
 .../skills/init/scripts/generate_agents.ts  |  291 +++++
 .../skills/review-and-commit-beta/SKILL.md  |  316 ++++++
 .claude/skills/review-and-commit/SKILL.md   |  315 ++++++
 .../adapt-instructions/SKILL.md       |   85 ++
 .claude/skills/ai-ide-runner/SKILL.md |  289 +++++
 .../references/models.md                           |  109 ++
 .../references/runtimes.md                         |  299 ++++++
 .../skills/analyze-context/SKILL.md   |   52 +
 .../scripts/count_tokens.ts                        |   45 +
 .../scripts/count_tokens_test.ts                   |   42 +
 .../browser-automation/SKILL.md       |   52 +
 .../conduct-qa-session/SKILL.md       |   82 ++
 .../configure-deno-commands/SKILL.md  |   65 ++
 .claude/skills/deep-research/SKILL.md |  238 +++++
 .../assets/report_template.md                      |   97 ++
 .../draw-mermaid-diagrams/SKILL.md    |   63 ++
 .../references/SPEC.md                             |  212 ++++
 .../scripts/validate.ts                            |  108 ++
 .../scripts/validate_test.ts                       |   19 +
 .../SKILL.md                                       |  119 +++
 .../SKILL.md                                       |  135 +++
 .claude/skills/epic/SKILL.md          |  205 ++++
 .claude/skills/fix-tests/SKILL.md     |   43 +
 .../SKILL.md                                       |  120 +++
 .../assets/flowchart.html                          | 1110 ++++++++++++++++++++
 .../assets/sequence.html                           |  666 ++++++++++++
 .claude/skills/investigate/SKILL.md   |   62 ++
 .claude/skills/jit-review/SKILL.md    |  235 +++++
 .claude/skills/maintenance/SKILL.md   |  198 ++++
 .../manage-github-tickets/SKILL.md    |   73 ++
 .claude/skills/plan-adr/SKILL.md      |   87 ++
 .claude/skills/plan/SKILL.md          |  111 ++
 .../reflect-by-history/SKILL.md       |  222 ++++
 .claude/skills/reflect/SKILL.md       |  211 ++++
 .claude/skills/review/SKILL.md        |  241 +++++
 .../SKILL.md                                       |  308 ++++++
 ...
 .claude/skills/write-dep/SKILL.md     |  261 +++++
 .../skills/write-gods-tasks/SKILL.md  |   82 ++
 .../SKILL.md                                       |  112 ++
 .claude/skills/write-prd/SKILL.md     |  138 +++
 .claude/skills/update/SKILL.md              |  177 ++++
 .../update/scripts/validate_frontmatter.ts  |  263 +++++
...
5. **ADR** (`documents/adr/<YYYY-MM-DD>-<slug>.md`): Architecture Decision Records (MADR-style). Persistent (NOT gitignored). Created by `plan-adr` when a non-trivial decision needs to outlive the task.
