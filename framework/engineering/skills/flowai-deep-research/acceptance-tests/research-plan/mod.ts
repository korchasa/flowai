...
export const DeepResearchPlanBench = new class extends AcceptanceTestScenario {
  id = "flowai-deep-research-plan";
  ...
  userQuery =
    "/flowai-deep-research Research the current state of WebAssembly adoption in server-side applications. Focus on performance benchmarks, production use cases, and limitations compared to native code.";
