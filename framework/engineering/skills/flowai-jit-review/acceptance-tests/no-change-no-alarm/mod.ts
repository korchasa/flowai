...
export const JitReviewNoChangeNoAlarmBench = new class
  ...
  id = "flowai-jit-review-no-change-no-alarm";
  ...
  userQuery =
    "/flowai-jit-review I refactored shipping.ts without changing behaviour. Please JIT-review my unstaged changes and confirm there's no hidden regression.";
