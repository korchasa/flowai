...
export const WriteInInformationalStyleTriggerPos1 = new class
  ...
  id = "flowai-write-in-informational-style-trigger-pos-1";
  ...
  checklist = [{
    id: "skill_invoked",
    description:
      "Did the agent load and act on `flowai-write-in-informational-style` in response to this query? Look in the trace for a `Skill` tool call or a read of the skill's `SKILL.md` for `flowai-write-in-informational-style`.",
    critical: true,
  }];
}();
