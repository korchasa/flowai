 ...
 *   - read sandbox/.claude/skills/flowai-conduct-qa-session/SKILL.md
 *   - read framework/engineering/skills/flowai-conduct-qa-session/
...
export const DiagnoseBenchMdPriorBulletsBench = new class
  ...
  id = "flowai-diagnose-benchmark-failure-md-prior-bullets";
  ...
  userQuery =
    "/flowai-diagnose-benchmark-failure flowai-conduct-qa-session-multi-select-format";
  ...
  checklist = [
    ...
    },
    {
      ...
      description:
        "Did the agent read the sandbox SKILL.md the failing agent saw, at acceptance-tests/runs/latest/<scenario-id>/run-1/sandbox/.claude/skills/flowai-conduct-qa-session/SKILL.md? Look for a Read tool call targeting that path.",
      critical: true,
    },
    {
      id: "read_scenario_mod",
      description:
        "Did the agent read the scenario file framework/engineering/skills/flowai-conduct-qa-session/benchmarks/multi-select-format/mod.ts to recover the checklist contract?",
      critical: true,
    },
    {
