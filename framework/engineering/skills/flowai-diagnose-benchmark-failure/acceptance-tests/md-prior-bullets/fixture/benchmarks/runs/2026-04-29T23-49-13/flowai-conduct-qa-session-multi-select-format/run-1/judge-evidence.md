...
Date:   Thu Apr 30 02:49:13 2026 +0300
 ...
 .../flowai-adapt-instructions/SKILL.md       |   85 ++
 .claude/skills/flowai-ai-ide-runner/SKILL.md |  289 +++++
 .../references/models.md                           |  109 ++
 .../references/runtimes.md                         |  299 ++++++
 .../skills/flowai-analyze-context/SKILL.md   |   52 +
 .../scripts/count_tokens.ts                        |   45 +
 .../scripts/count_tokens_test.ts                   |   42 +
 .../flowai-browser-automation/SKILL.md       |   52 +
 .../flowai-conduct-qa-session/SKILL.md       |   82 ++
 .../flowai-configure-deno-commands/SKILL.md  |   65 ++
 .claude/skills/flowai-deep-research/SKILL.md |  238 +++++
 .../assets/report_template.md                      |   97 ++
 .../flowai-draw-mermaid-diagrams/SKILL.md    |   63 ++
 .../references/SPEC.md                             |  212 ++++
 .../scripts/validate.ts                            |  108 ++
 .../scripts/validate_test.ts                       |   19 +
 .../SKILL.md                                       |  119 +++
 .../SKILL.md                                       |  135 +++
 .claude/skills/flowai-epic/SKILL.md          |  205 ++++
 .claude/skills/flowai-fix-tests/SKILL.md     |   43 +
 .../SKILL.md                                       |  120 +++
 .../assets/flowchart.html                          | 1110 ++++++++++++++++++++
 .../assets/sequence.html                           |  666 ++++++++++++
 .claude/skills/flowai-investigate/SKILL.md   |   62 ++
 .claude/skills/flowai-jit-review/SKILL.md    |  235 +++++
 .claude/skills/flowai-maintenance/SKILL.md   |  198 ++++
 .../flowai-manage-github-tickets/SKILL.md    |   73 ++
 .claude/skills/flowai-plan-adr/SKILL.md      |   87 ++
 .claude/skills/flowai-plan/SKILL.md          |  111 ++
 .../flowai-reflect-by-history/SKILL.md       |  222 ++++
 .claude/skills/flowai-reflect/SKILL.md       |  211 ++++
 .claude/skills/flowai-review/SKILL.md        |  241 +++++
 .../SKILL.md                                       |  308 ++++++
 ...
 .claude/skills/flowai-write-dep/SKILL.md     |  261 +++++
 .../skills/flowai-write-gods-tasks/SKILL.md  |   82 ++
 .../SKILL.md                                       |  112 ++
 .claude/skills/flowai-write-prd/SKILL.md     |  138 +++
...
5. **ADR** (`documents/adr/<YYYY-MM-DD>-<slug>.md`): Architecture Decision Records (MADR-style). Persistent (NOT gitignored). Created by `flowai-plan-adr` when a non-trivial decision needs to outlive the task.
