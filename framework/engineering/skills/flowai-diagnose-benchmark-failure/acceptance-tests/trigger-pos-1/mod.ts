...
export const DiagnoseBenchmarkFailureTriggerPos1 = new class
  ...
  id = "flowai-diagnose-benchmark-failure-trigger-pos-1";
  ...
  checklist = [{
    id: "skill_invoked",
    description:
      "Did the agent load and act on `flowai-diagnose-benchmark-failure` in response to this query? Look in the trace for a `Skill` tool call or a read of the skill's `SKILL.md` for `flowai-diagnose-benchmark-failure`.",
    critical: true,
  }];
}();
