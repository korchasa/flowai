...
export const AiIdeRunnerSingleCursorBench = new class
  ...
  id = "flowai-skill-ai-ide-runner-single-cursor-read-only";
  ...
  userQuery =
    "/flowai-skill-ai-ide-runner Get a second opinion from Cursor (read-only, no edits) on the question: 'What does this repository do?'. Use Cursor's default model. Return the answer verbatim and tell me which model ran.";
