...
// Adjacent skill: flowai-skill-fix-tests (the user has a known failing test
// and wants it fixed; not a search for hidden regressions).
export const JitReviewTriggerAdj1 = new class extends BenchmarkSkillScenario {
  id = "flowai-skill-jit-review-trigger-adj-1";
