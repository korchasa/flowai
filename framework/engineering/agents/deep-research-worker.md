...
description: Research worker for a single direction within a deep research task. Receives a direction, queries, and acceptance criteria; searches the web, evaluates sources, extracts facts, and saves structured output to a temp file. Spawned sequentially by the deep-research orchestrator — do NOT invoke directly for general research.
