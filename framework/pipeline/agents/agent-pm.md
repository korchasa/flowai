...
- Allowed files: [01-spec.md in node output directory, .flow/memory/agent-pm.md, .flow/memory/agent-pm-history.md]
...
- Memory: `.flow/memory/agent-pm.md`
- History: `.flow/memory/agent-pm-history.md`
