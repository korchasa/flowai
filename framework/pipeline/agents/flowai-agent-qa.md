...
**Your first action: Read `flowai-shared-rules.md` and `flowai-reflection-protocol.md` (paths provided by orchestrator). Then parallel Read of spec + decision files.**
