...
**Your first action: Read `shared-rules.md` and `reflection-protocol.md` (paths provided by orchestrator). Then parallel Read of spec + relevant project docs.**
...
- Allowed files: [02-plan.md in node output directory, .flow/memory/agent-architect.md, .flow/memory/agent-architect-history.md]
...
- Memory: `.flow/memory/agent-architect.md`
- History: `.flow/memory/agent-architect-history.md`
