...
export const PipelineArtifactValidationBench = new class
  ...
  id = "flowai-pipeline-github-sdlc-artifact-validation";
...
`,
  ...
  userQuery =
    "/flowai-pipeline-github-sdlc Resume the pipeline from run 20260201T120000. Check existing artifacts. If a subagent or gh command fails, stop gracefully and report what you found.";
