...
export const PipelineInitStructureBench = new class
  ...
  id = "flowai-pipeline-github-sdlc-init-structure";
  ...
  userQuery =
    "/flowai-pipeline-github-sdlc Start a new SDLC pipeline run. If issue triage fails, stop and report what was initialized.";
