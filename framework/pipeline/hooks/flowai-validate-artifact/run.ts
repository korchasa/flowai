...
/**
 * flowai-validate-artifact hook: validates YAML frontmatter and required fields
...
if (import.meta.main) {
  ...
  if (!result.valid) {
    console.log(JSON.stringify({
      additionalContext:
        `[flowai-validate-artifact] Artifact ${filePath} is missing required YAML frontmatter fields: ${
          result.missing.join(", ")
