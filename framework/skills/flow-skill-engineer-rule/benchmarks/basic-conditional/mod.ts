...
export const EngineerRuleConditionalBench = new class
  ...
  id = "flow-skill-engineer-rule-conditional";
  name = "Create a conditional TypeScript error handling rule";
  skill = "flow-skill-engineer-rule";

  userQuery =
    "/flow-skill-engineer-rule Create a rule that enforces typed error handling in TypeScript files: always use custom error classes, never catch without re-throwing or logging, and always include error context. This should only apply to .ts files.";
