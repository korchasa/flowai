...
export const FlowUpdateTemplateVsArtifactBench = new class
  ...
  id = "flow-update-template-vs-artifact";
  name =
    "Compares templates against project artifacts (not just template git diff)";
  skill = "flow-update";

  fixturePath = "framework/skills/flow-update/benchmarks/template-vs-artifact/fixture";
...
`,
  ...
  userQuery =
    "/flow-update I already ran `flowai sync` and it updated some skills. Please skip the CLI update and sync steps. Start from step 3: detect what changed in .claude/ via git, analyze diffs, compare templates against project artifacts, and propose migrations.";
