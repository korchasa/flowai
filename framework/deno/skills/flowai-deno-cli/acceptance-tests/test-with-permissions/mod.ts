...
export const DenoCliTestPermsBench = new class extends AcceptanceTestScenario {
  id = "flowai-deno-cli-test-permissions";
  ...
  userQuery =
    "/flowai-deno-cli I want to run the tests for this project. The server uses Deno KV. What permissions do I need and what is the correct command? Also, how do I add a new dependency from JSR?";
