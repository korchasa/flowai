...
export const AiIdeRunnerDefaultNativeIdeBench = new class
  ...
  id = "ai-ide-runner-default-native-ide-for-model";
  ...
  userQuery =
    "/ai-ide-runner Run this question with Claude Sonnet (I don't care which IDE, just pick the sensible default) and return the answer verbatim: 'What is one rule of thumb for writing maintainable TypeScript?'. Tell me which IDE and which model you ended up using.";
