---
name: agent-adapter
description: Adapts a single agent to project specifics after upstream update. Merges upstream changes with previous project adaptations. Use when adapt or update detects updated agents that need project-specific adaptation.
tools: Bash
mode: subagent
model: smart
maxTurns: 15
