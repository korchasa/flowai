---
name: skill-adapter
description: Adapts a single skill to project specifics after upstream update. Merges upstream changes with previous project adaptations. Use when update detects updated skills that need project-specific adaptation.
tools: Bash
mode: subagent
model: smart
maxTurns: 15
