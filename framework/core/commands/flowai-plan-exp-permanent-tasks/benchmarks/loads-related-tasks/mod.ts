...
//   - documents/tasks/2026/04/01/add-login-form.md   (implements: FR-AUTH-LOGIN)
//   - documents/tasks/2026/04/02/add-profile-edit.md (implements: FR-PROFILE-EDIT)
  ...
  checklist = [
    {
      ...
      description:
        "In Step 2 (Deep Context), did the agent identify and name `add-login-form` (under documents/tasks/2026/04/01/) as a related task because its `implements:` includes FR-AUTH-LOGIN, which is also in the planned task's implements? The agent must explicitly mention this prior task in chat as loaded context.",
      critical: true,
    },
    {
      id: "skips_unrelated_profile_task",
      description:
        "Did the agent CORRECTLY skip `add-profile-edit` (under documents/tasks/2026/04/02/) — its `implements:` is FR-PROFILE-EDIT which has no intersection with the planned task's FR-AUTH-LOGIN? The unrelated task must NOT appear as loaded context.",
      critical: true,
    },
    {
