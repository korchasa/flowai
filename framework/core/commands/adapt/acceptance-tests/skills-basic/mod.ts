...
/**
 * Tests that adapt adapts skills to project specifics.
 *
 * Scenario:
 * 1. Python project with pytest/ruff stack (visible in AGENTS.md)
 * 2. commit skill installed with generic Deno examples
 * 3. User runs /adapt --skills
...
`;
  ...
  checklist = [
    ...
    },
    {
      ...
      description:
        "Did the agent launch a skill-adapter subagent (or similar adaptation agent) for the skill?",
      critical: true,
    },
    {
      id: "showed_diff",
