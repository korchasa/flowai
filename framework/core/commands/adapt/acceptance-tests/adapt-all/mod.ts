...
/**
 * Tests that adapt adapts ALL primitive types in one run.
 *
 * Scenario:
 ...
 * 4. User runs /adapt (no flags — adapt everything)
 * 5. Agent should adapt skills, agents, verify AGENTS.md, and produce summary
 */
export const FlowAdaptAllBench = new class extends AcceptanceTestScenario {
  id = "adapt-all";
