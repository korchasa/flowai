...
description: Re-adapt AGENTS.md when the installed template changed. Reads {ide}/assets/AGENTS.template.md, diffs it against the project AGENTS.md, proposes a merge preserving project-specific sections, asks for confirmation, writes on approval. Use after `flowai sync` reports AGENTS.template.md changed.
---
