...
export const FlowUpdateTemplateVsArtifactBench = new class
  ...
  id = "update-template-vs-artifact";
  name =
  ...
  userQuery =
    "/update Reconcile my project AGENTS.md with the currently installed flowai framework template. Some project-local installed skill files also changed, but do not adapt or rewrite skills and do not run flowai CLI commands.";
