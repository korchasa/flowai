...
export const FlowUpdateBasicBench = new class extends AcceptanceTestScenario {
  ...
  userQuery =
    "/update Reconcile my project AGENTS.md with the currently installed flowai framework template. Do not run flowai CLI commands or rewrite installed skills.";
