...
export const FlowUpdatePluginUserScopeBench = new class
  ...
  userQuery =
    "/update My flowai skills are installed through an IDE plugin/user-level install. Do not run flowai CLI commands. Reconcile my project AGENTS.md with the framework instructions, and do not rewrite installed skills or plugin cache files.";
