...
export const ReviewAndCommitAutoInvokeReflectBench = new class
  ...
  override sandboxState = {
    ...
    untracked: ["utils.ts"],
    expectedOutcome:
      "Agent reviews untracked utils.ts, approves, commits, detects session complexity, and auto-invokes /reflect (actually executes the reflect workflow)",
  };
...
If asked whether to apply edits reflect proposes to the instruction files, reply: 'apply'.
