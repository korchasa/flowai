...
`;
  ...
  userQuery =
    "/flowai-commit Started the search page (renders results works; pagination + empty-state still TODO). The task at documents/tasks/2026/04/add-search-page.md tracks the work. Commit what we have.";
