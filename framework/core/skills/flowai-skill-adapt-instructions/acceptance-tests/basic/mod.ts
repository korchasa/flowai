...
export const FlowAdaptInstructionsBasicBench = new class
  ...
  id = "flowai-skill-adapt-instructions-basic";
  ...
  userQuery =
    "/flowai-skill-adapt-instructions The AGENTS.md template in .claude/assets/ was updated recently. Please re-adapt my AGENTS.md so it matches the new template but keeps my project-specific sections (vision, stack, decisions, planning).";
