...
export const CatchesIssuesBench = new class extends AcceptanceTestScenario {
  id = "flowai-skill-review-catches-issues";
  ...
  userQuery =
    "/flowai-skill-review The login function is implemented, please review";
