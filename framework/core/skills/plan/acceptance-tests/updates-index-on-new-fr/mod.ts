...
export const PlanUpdatesIndexBench = new class extends AcceptanceTestScenario {
  id = "plan-updates-index-on-new-fr";
...
Do NOT request changes to the plan structure or to file outputs.`;
  ...
  userQuery =
    "/plan Plan a feature: add an explicit '/flowai-pause' command that lets the user temporarily pause the agent for a specified duration. This introduces a new requirement FR-PAUSE (Pause Command). Frontmatter implements: must list FR-PAUSE.";
