...
export const ReflectSelfCriticismBench = new class
  ...
  id = "flowai-reflect-self-criticism";
  ...
  userQuery =
    "Analyze the agent's performance in transcript.txt using flowai-reflect. Identify issues and evaluate your own analysis before presenting the final report.";
