...
export const WriteGodsTasksBasicBench = new class
  ...
  userQuery =
    "/write-gods-tasks Write a task for migrating the Alpha service from virtual machines to Docker containers. Currently, deployment takes 45 minutes and causes errors during updates. We need to reduce deployment time by 50% and eliminate update errors.";
