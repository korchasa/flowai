...
export const CommitTaskCleanupBench = new class extends AcceptanceTestScenario {
  id = "commit-task-cleanup";
...
`;
  ...
  userQuery =
    "/commit Implemented the /users endpoint as planned in the task file documents/tasks/2026-03-28-add-users-api.md. Commit the changes.";
