...
// Verifies FR-DOC-TASK-LIFECYCLE: commit derives task `status` from
...
`;
  ...
  userQuery =
    "/commit Implemented the rate limiter described in the task at documents/tasks/2026/04/add-rate-limiter.md. All DoD items are now satisfied. Commit the changes.";
