...
export const CommitAtomicHunkBench = new class extends AcceptanceTestScenario {
  id = "commit-atomic-hunk";
  ...
  userQuery =
    "/commit Commit changes. I renamed a function (logic) and added a comment (style). Split them into two commits (style and refactor).";
