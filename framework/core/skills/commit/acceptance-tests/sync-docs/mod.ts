...
export const CommitSyncDocsBench = new class extends AcceptanceTestScenario {
  id = "commit-sync-docs";
  ...
  userQuery =
    "/commit I added a new feature in src.ts. Commit changes, but first update the documentation in documents/README.md to reflect the changes.";
