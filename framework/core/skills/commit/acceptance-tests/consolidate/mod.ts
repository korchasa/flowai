...
export const CommitConsolidateBench = new class extends AcceptanceTestScenario {
  id = "commit-consolidate";
  ...
  userQuery =
    "/commit I added a multiply function with tests and updated the README. Commit the changes.";
