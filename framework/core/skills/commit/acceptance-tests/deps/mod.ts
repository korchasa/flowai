...
export const CommitDepsBench = new class extends AcceptanceTestScenario {
  id = "commit-deps";
  ...
  userQuery =
    "/commit Commit changes. I updated the version in deno.json and the logic in mod.ts. Split them.";
