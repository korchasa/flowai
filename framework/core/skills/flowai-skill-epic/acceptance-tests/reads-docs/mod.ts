...
export const EpicReadsDocsBench = new class extends AcceptanceTestScenario {
  id = "flowai-skill-epic-reads-docs";
  ...
  userQuery =
    "/flowai-skill-epic User authentication system with OAuth2 and JWT tokens.";
