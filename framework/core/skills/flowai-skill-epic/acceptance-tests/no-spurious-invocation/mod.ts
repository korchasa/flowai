...
export const EpicNoSpuriousInvocationBench = new class
  ...
  id = "flowai-skill-epic-no-spurious-invocation";
  ...
  checklist = [
    ...
    },
    {
      ...
      description:
        "Did the agent answer with a short definition of 'epic' (agile usage), rather than entering the flowai-skill-epic workflow?",
      critical: true,
    },
  ];
}();
