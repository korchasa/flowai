...
export const PlanReadsDocsBench = new class extends BenchmarkSkillScenario {
  id = "flowai-plan-reads-docs";
  ...
  userQuery = "/flowai-plan Add a caching layer for the API endpoints.";
