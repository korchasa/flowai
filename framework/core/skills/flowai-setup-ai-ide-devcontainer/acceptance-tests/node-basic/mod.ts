...
export const SetupDevcontainerNodeBasic = new class
  ...
  id = "flowai-setup-ai-ide-devcontainer-node-basic";
  ...
  userQuery =
    "/flowai-setup-ai-ide-devcontainer Set up a devcontainer for this Node.js project. Use Claude Code as AI CLI. No global skills mount. No firewall. No custom Dockerfile.";
