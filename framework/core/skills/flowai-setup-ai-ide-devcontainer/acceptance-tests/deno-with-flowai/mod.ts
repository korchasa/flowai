...
export const SetupDevcontainerDenoWithFlowai = new class
  ...
  id = "flowai-setup-ai-ide-devcontainer-deno-flowai";
  ...
  userQuery =
    "/flowai-setup-ai-ide-devcontainer Set up a devcontainer for this Deno project with flowai CLI integration.";
