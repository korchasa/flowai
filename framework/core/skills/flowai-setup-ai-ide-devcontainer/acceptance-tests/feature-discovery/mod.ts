...
export const SetupDevcontainerFeatureDiscovery = new class
  ...
  id = "flowai-setup-ai-ide-devcontainer-feature-discovery";
  name =
  ...
  userQuery =
    "/flowai-setup-ai-ide-devcontainer Set up a devcontainer for this Node.js fullstack project with Claude Code. Accept all suggested features.";
