...
export const SetupDevcontainerOpenCodeMultiCli = new class
  ...
  id = "flowai-setup-ai-ide-devcontainer-opencode-multi-cli";
  ...
  userQuery =
    "/flowai-setup-ai-ide-devcontainer Set up a devcontainer for this Python project. Install both Claude Code and OpenCode. Mount global skills from host. No firewall. No custom Dockerfile.";
