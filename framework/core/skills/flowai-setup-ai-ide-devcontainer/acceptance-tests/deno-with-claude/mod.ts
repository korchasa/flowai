...
export const SetupDevcontainerDenoWithClaude = new class
  ...
  id = "flowai-setup-ai-ide-devcontainer-deno-claude";
  ...
  userQuery =
    "/flowai-setup-ai-ide-devcontainer Set up a devcontainer for this Deno project with full Claude Code integration, global skills mounting, and security hardening.";
