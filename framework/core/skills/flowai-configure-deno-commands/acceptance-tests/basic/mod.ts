...
export const ConfigureDenoCommandsBasicBench = new class
  ...
  id = "flowai-configure-deno-commands-basic";
  ...
  userQuery =
    "/flowai-configure-deno-commands Set up the standard Deno development commands (check, test, dev, prod) for this project.";
