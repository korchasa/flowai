...
export const PlanAutoCritiqueBench = new class extends AcceptanceTestScenario {
  id = "flowai-skill-plan-auto-critique";
...
After variant selection, say NOTHING further. Do NOT answer any follow-up question about which critique points to apply — if the agent asks, stay silent.`;
  ...
  userQuery =
    "/flowai-skill-plan Plan adding a /health endpoint to index.js with a startup probe and readiness logic for a Redis-backed cache.";
