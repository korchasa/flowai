...
export const PlanRefactorBench = new class extends AcceptanceTestScenario {
  id = "flowai-skill-plan-refactor";
  ...
  userQuery =
    "/flowai-skill-plan Plan a refactoring of src/UserManager.ts to separate concerns. It does too much right now.";
