...
// review-and-commit MUST NOT re-run `git diff` at the top of Phase 2
...
export const ReviewAndCommitPhase2DiffEliminatedBench = new class
  ...
  id = "review-and-commit-phase-2-diff-eliminated";
  ...
  userQuery =
    "/review-and-commit Review and commit the added utility functions.";
