...
export const ApproveAndCommitBench = new class extends AcceptanceTestScenario {
  id = "review-and-commit-approve";
  ...
  userQuery = "/review-and-commit Review and commit the added sum function";
...
Keep answers brief and affirmative.`;
  ...
  checklist = [
    ...
    },
    {
      ...
      description:
        "Did the agent correctly skip the /reflect suggestion? In a simple session without errors, retries, or user corrections, the agent must NOT suggest running /reflect.",
      critical: false,
    },
    {
