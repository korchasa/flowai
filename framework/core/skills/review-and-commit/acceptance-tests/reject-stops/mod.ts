...
export const RejectStopsBench = new class extends AcceptanceTestScenario {
  id = "review-and-commit-reject";
  ...
  userQuery =
    "/review-and-commit The divide function is implemented, review and commit";
