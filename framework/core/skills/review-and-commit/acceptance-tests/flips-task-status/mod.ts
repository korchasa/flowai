...
// the frontmatter — same logic as commit, but exercised through the
...
`;
  ...
  userQuery =
    "/review-and-commit Implemented the rate limiter described in the task at documents/tasks/2026/04/add-rate-limiter.md. All DoD items are now satisfied. Review and commit.";
