...
export const ReviewNoGroupingBench = new class extends BenchmarkSkillScenario {
  id = "flowai-review-no-grouping";
  name =
  ...
  userQuery =
    "/flowai-review Review the data processor implementation (processor.ts)";
