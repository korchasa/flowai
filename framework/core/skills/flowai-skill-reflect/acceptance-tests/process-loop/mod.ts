...
export const ReflectLoopBench = new class extends AcceptanceTestScenario {
  id = "flowai-skill-reflect-loop";
  ...
  userQuery =
    "Analyze the agent's performance in transcript.txt using flowai-skill-reflect. Identify the main logical error.";
