...
export const ReflectSessionHistoryBench = new class
  ...
  id = "flowai-skill-reflect-session-history";
  ...
  userQuery =
    "Analyze the current session transcript (transcript.txt) AND the session history in session-history/ using flowai-skill-reflect. Determine whether the errors in the current session are isolated incidents or recurring patterns across sessions.";
