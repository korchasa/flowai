...
// Adjacent skill: flowai-skill-reflect-by-history (review of PAST sessions
// from IDE transcripts, not the current conversation).
export const ReflectTriggerAdj1 = new class extends BenchmarkSkillScenario {
  id = "flowai-skill-reflect-trigger-adj-1";
