 ...
 */
export const MemexSaveNewBench = new class extends AcceptanceTestScenario {
  id = "flowai-memex-save-new";
  ...
  userQuery =
    "/flowai-memex-save source.md — please add this article to my memex";
