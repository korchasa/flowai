...
export const MemexAuditTriggerPos1 = new class extends AcceptanceTestScenario {
  id = "flowai-memex-audit-trigger-pos-1";
  ...
  checklist = [{
    id: "skill_invoked",
    description:
      "Did the agent load and act on `flowai-memex-audit` in response to this query? Look in the trace for a `Skill` tool call or a read of the skill's `SKILL.md` for `flowai-memex-audit`.",
    critical: true,
  }];
}();
