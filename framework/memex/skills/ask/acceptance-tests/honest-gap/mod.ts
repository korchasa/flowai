...
export const MemexAskHonestGapBench = new class extends AcceptanceTestScenario {
  ...
  userQuery =
    "/ask What are the main features of the Tokio Rust async runtime?";
  ...
  checklist = [
    ...
    },
    {
      id: "suggests_save",
      description:
        "Did the agent suggest running `save` (or equivalent) to add Rust/Tokio sources to fill the gap?",
      critical: true,
    },
    {
