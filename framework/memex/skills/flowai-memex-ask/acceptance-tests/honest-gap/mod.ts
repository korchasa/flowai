...
export const MemexAskHonestGapBench = new class extends AcceptanceTestScenario {
  id = "flowai-memex-ask-honest-gap";
  ...
  userQuery =
    "/flowai-memex-ask What are the main features of the Tokio Rust async runtime?";
  ...
  checklist = [
    ...
    },
    {
      id: "suggests_save",
      description:
        "Did the agent suggest running `flowai-memex-save` (or equivalent) to add Rust/Tokio sources to fill the gap?",
      critical: true,
    },
    {
