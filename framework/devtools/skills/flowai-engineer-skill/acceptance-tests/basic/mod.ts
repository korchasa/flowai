...
export const EngineerSkillBasicBench = new class
  ...
  id = "flowai-engineer-skill-basic";
  ...
  userQuery =
    "/flowai-engineer-skill Create a skill that helps generate database migration files for PostgreSQL. It should guide through creating up/down migrations with proper naming conventions (timestamp-based), handle common patterns like adding columns, creating tables, and adding indexes. Place it as a project skill for Cursor.";
