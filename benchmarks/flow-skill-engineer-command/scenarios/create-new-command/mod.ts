...
export const EngineerCommandCreateBench = new class
  ...
  id = "flow-skill-engineer-command-create";
  name = "Create a new AssistFlow command for Docker Compose management";
  skill = "flow-skill-engineer-command";
  stepTimeoutMs = 300_000;

  userQuery =
    '/flow-skill-engineer-command I want to create a command called "flow-docker-compose" that helps manage Docker Compose services. It should help with starting/stopping services, viewing logs, rebuilding containers, and checking health. This is a project-level command.';
