...
export const DenoCliTestPermsBench = new class extends BenchmarkSkillScenario {
  id = "flow-skill-deno-cli-test-permissions";
  name = "Run Deno tests and diagnose permission requirements";
  skill = "flow-skill-deno-cli";

  userQuery =
    "/flow-skill-deno-cli I want to run the tests for this project. The server uses Deno KV. What permissions do I need and what is the correct command? Also, how do I add a new dependency from JSR?";
