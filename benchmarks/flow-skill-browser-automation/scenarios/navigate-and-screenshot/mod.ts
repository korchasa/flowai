...
export const BrowserAutomationNavigateBench = new class
  ...
  id = "flow-skill-browser-automation-navigate-and-screenshot";
  name = "Navigate to Page and Take Screenshot";
  skill = "flow-skill-browser-automation";
  stepTimeoutMs = 120_000;
  maxSteps = 15;

  userQuery =
    "/flow-skill-browser-automation Open https://example.com, capture the page structure, then take a screenshot.";
