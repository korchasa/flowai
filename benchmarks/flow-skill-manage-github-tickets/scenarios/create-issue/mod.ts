...
export const ManageGithubTicketsCreateIssueBench = new class
  ...
  id = "flow-skill-manage-github-tickets-create-issue";
  name = "Create GitHub Issue Using GODS Framework";
  skill = "flow-skill-manage-github-tickets";

  userQuery =
    "/flow-skill-manage-github-tickets Create a GitHub issue for our CI/CD pipeline being broken. Jenkins plugin update caused 5 builds to fail. We need to restore builds within 1 hour. Repo: acme/backend.";
