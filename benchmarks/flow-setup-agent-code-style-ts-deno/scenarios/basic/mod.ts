...
export const SetupCodeStyleTsDenoBasicBench = new class
  ...
  id = "flow-setup-agent-code-style-ts-deno-basic";
  name = "Inject Deno/TS code style rules into AGENTS.md";
  skill = "flow-setup-agent-code-style-ts-deno";

  userQuery =
    "/flow-setup-agent-code-style-ts-deno Add Deno TypeScript code style rules to this project.";
