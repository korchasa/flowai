...
export const EngineerPromptsForReasoningBench = new class
  ...
  id = "flow-skill-engineer-prompts-for-reasoning-basic";
  name = "Write a prompt for a reasoning model to refactor code";
  skill = "flow-skill-engineer-prompts-for-reasoning";

  userQuery =
    "/flow-skill-engineer-prompts-for-reasoning Help me write a prompt for Claude 3.5 Sonnet that analyzes a Python codebase for security vulnerabilities and produces a prioritized report with remediation steps.";
