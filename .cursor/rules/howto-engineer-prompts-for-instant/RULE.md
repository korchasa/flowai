---
description: Guide for writing stable, effective prompts for instant/fast models (Gemini Flash, GPT-4o Mini, Haiku), suitable for beginners.
alwaysApply: false
---
...
Input: [Short Example Input 2]
Output: [Perfect Example Output 2]
...
# EXAMPLES
Input: "Hi, can you buy milk by 5pm? Also, the weather is nice."
Output: ["Buy milk (Deadline: 5pm)"]

Input: "Just checking in. Please submit the report tomorrow."
Output: ["Submit report (Deadline: Tomorrow)"]
