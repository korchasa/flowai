...
4.  **Report**:
    ...
    *   **Details**:
        ...
        *   **Evidence**: For EACH failed item, provide the specific proof.
            *   *Example*: "Check 'file_created' failed. Evidence: `ls benchmarks/af-init-basic/sandbox/src/` shows the directory is empty."
            *   *Example*: "Check 'correct_prefix' failed. Evidence: `git log -1` shows commit message 'update readme' instead of 'docs: update readme'."
