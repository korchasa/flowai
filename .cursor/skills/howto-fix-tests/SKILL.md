...
6. Create hypothes: Create the most likely hypothesis about the cause of the
   error.
7. Test hypothes: Methodically test the created hypothesis, making small,
   incremental changes and documenting each step.
