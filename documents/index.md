...
- [FR-DO-WITH-PLAN](requirements.md#fr-do-with-plan-full-cycle-workflow-do-with-plan) — Full-cycle workflow command: plan → implement → review-and-commit (composite, user-only) — [x]
