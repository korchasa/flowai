...
- [FR-BENCH.TRIGGER](requirements.md#fr-benchtrigger-skill-description-matching-verification) — Skill description-matching verified by 3 trigger scenarios per skill — [x]
- [FR-DO-WITH-PLAN](requirements.md#fr-do-with-plan-full-cycle-workflow--flowai-do-with-plan) — Full-cycle workflow command: plan → implement → review-and-commit (composite, user-only) — [ ]
