...
- [FR-DIAGNOSE-BENCH](requirements.md#fr-diagnose-bench-benchmark-failure-diagnostic-skill-diagnose-benchmark-failure) — Benchmark failure diagnostic skill — [x]
...
- [FR-SHIP](requirements.md#fr-ship-terminal-full-cycle-workflow-ship) — Terminal full-cycle workflow — ship (plan → do → review → commit → push, 4 gates) — [x]
...
- [FR-UPDATE](requirements.md#fr-update-framework-update-update) — Framework update command — [ ]
