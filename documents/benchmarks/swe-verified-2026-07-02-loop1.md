...
**Update (same day): the noise floor was measured — see `swe-verified-2026-07-02-noisefloor.md`.** Three reps of the unchanged pipeline scored 0 / 2 / 1 resolved; `django-13195` flips between the two co-temporal reps (unconditional proof of non-determinism). The "1/13 → 0/12" delta this report analyzed sits entirely inside that same-day 0–2 spread — it was sampling noise, not an effect of the plan edit.
