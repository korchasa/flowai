// [REF:fr:accept | FR-ACCEPT] — OpenAI Codex acceptance test adapter
/**
...
export class CodexAdapter implements AgentAdapter {
  ...
  async setupMocks(
    ...
    // [REF:fr:dist.codex-hooks | FR-DIST.CODEX-HOOKS] — Codex supports hooks via `<repo>/.codex/hooks.json`
